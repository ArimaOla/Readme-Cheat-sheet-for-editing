...
[spoiler]Для описания проектов на GitHub используется README.md, который пишется на языке разметки markdown. Что и как поддерживается расписано ниже.
Не забудьте при создании нового файла в названии репозитория указать `.md` [/spoiler]
...
1. Разделительная черта <details>
<summary> При использовании </summary>
При использовании
```
____ 
```
...
3. <details>
<summary>Работа с выделением текста </summary>
```
~~Зачеркнутый текст~~
```
...
4. <details>
<summary>Использование эмодзи </summary>
...
Список работающих Эмодзи находится тут -> [emoji.md](#EMOJI-CHEAT-SHEET)
</details>

5. <details>
<summary>Использование цитирования в тексте </summary>
```
> Цитата (уровень 1)    
...
6. <details>
<summary>Подсветка кода </summary>
...
9. <details>
<summary>Вставка таблиц </summary>
Тут текст который вы хотим скрыть
</details>

10. <details>
<summary>Вставка изображения </summary>
```
...
https://docs.github.com/en/free-pro-team@latest/github/writing-on-github/basic-writing-and-formatting-syntax#links 
</details>
